...
const CarrierLogoGrid = ({
  ...
  subheading = 'TruClaim Advisory Group has direct field experience with the following carriers — serving as a policyholder-appointed appraiser, a carrier-retained appraiser, and a neutral umpire.',
