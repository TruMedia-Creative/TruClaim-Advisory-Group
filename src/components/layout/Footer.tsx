        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center space-x-3 mb-4">
              <div className="w-12 h-12 bg-gradient-to-br from-rosy-copper-500 to-rosy-copper-400 rounded-full flex items-center justify-center">
          ...
          {/* Quick Links */}
          <div>
            <h3 className="font-semibold text-lg mb-4 text-rosy-copper-500">Quick Links</h3>
          ...
          {/* Contact */}
          <div>
            <h3 className="font-semibold text-lg mb-4 text-rosy-copper-500">Contact</h3>
